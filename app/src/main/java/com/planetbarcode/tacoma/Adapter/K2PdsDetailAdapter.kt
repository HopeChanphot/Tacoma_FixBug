...
class K2PdsDetailAdapter(private var Dataset:ArrayList<K2PdsDetailModel>, private val context: Context) : RecyclerView.Adapter<K2PdsDetailAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): K2PdsDetailAdapter.MyViewHolder {
        val inflater = LayoutInflater.from(context)
        val view = inflater.inflate(R.layout.k2pds_list, parent, false)
        return MyViewHolder(view)
    }

    override fun onBindViewHolder(holder: K2PdsDetailAdapter.MyViewHolder, position: Int) {
